...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${base}/maintenance`, lastModified, changeFrequency: "daily",  priority: 0.8 },
    { url: `${base}/support`,     lastModified, changeFrequency: "daily",  priority: 0.8 },
    { url: `${base}/incident`,    lastModified, changeFrequency: "daily",  priority: 0.7 },
    { url: `${base}/contact`,     lastModified, changeFrequency: "daily", priority: 0.6 },
  ];
}
